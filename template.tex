...
\fancyhead[RO, LE]{\textsf{FLOSS UK Newsletter}}
\fancyhead[RE, LO]{\textsf{news@UK}}
\pagestyle{fancy}

%%%
%%% End newsletter edits
%%%
...
\begingroup
  ...
  \vspace{-1 mm}
  \sffamily
  \bfseries Volume 25, Number 1\vspace{1 mm}
  \hfill
  ISSN 0965-9412\hfill
  % </number>
  May 2016\vspace{0 mm}
  \hrule
\endgroup
...
% Always put a page break after the table of contents
\pagebreak
